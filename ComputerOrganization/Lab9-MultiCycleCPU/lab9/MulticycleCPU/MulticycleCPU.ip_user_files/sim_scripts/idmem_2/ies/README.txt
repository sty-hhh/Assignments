...
#
# Generated by export_simulation on Sat Dec 19 18:03:55 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './idmem.sh' script.
...
./idmem.sh -noclean_files

For more information on the script, please type './idmem.sh -help'.
