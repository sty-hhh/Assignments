...
#define Pi 3.1415
#define node_quantaty 50000
#define path_length 0.5         //路径一段0.5m
#define path_zone 0.6           //每条路径检测周围的障碍点的范围
#define target_map_x -2       //终点x
#define target_map_y -2.7      //终点y
#define width 4.5             //地图宽
#define height 6.0             //地图高
...
int Mazerobot::point2point(double imu, double x_car, double y_car, double x_target, double y_target) {
    ...
    if (angle_imu > Pi/8) go(-15, 15, -15, 15, 0, 0);
    else if (angle_imu < -Pi/8) go(15,-15, 15, -15, 0, 0);
